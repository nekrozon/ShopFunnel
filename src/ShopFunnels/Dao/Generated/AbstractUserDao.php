...
class AbstractUserDao
{
    ...
    /**
     * Get a list of User filtered by login.
     *
     * @param string $login
     * @param mixed $orderBy The order string
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     ...
     * @return User[]|ResultIterator
     */
    public function findByLogin(string $login, $orderBy = null, array $additionalTablesFetch = array(), ?int $mode = null) : iterable
    {
        $filter = [
            'login' => $login,
        ];
    ...
    /**
     * Get a list of User filtered by email.
     *
     * @param string $email
     * @param mixed $orderBy The order string
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     ...
     * @return User[]|ResultIterator
     */
    public function findByEmail(string $email, $orderBy = null, array $additionalTablesFetch = array(), ?int $mode = null) : iterable
    {
        $filter = [
            'email' => $email,
        ];
    ...
    /**
     * Get a list of User filtered by token.
     *
     * @param string $token
     * @param mixed $orderBy The order string
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     ...
     * @return User[]|ResultIterator
     */
    public function findByToken(string $token, $orderBy = null, array $additionalTablesFetch = array(), ?int $mode = null) : iterable
    {
        $filter = [
            'token' => $token,
        ];
